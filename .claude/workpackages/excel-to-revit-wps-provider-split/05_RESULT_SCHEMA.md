# EXCEL TO REVIT — WPS PROVIDER SPLIT — RESULT SCHEMA (v1)
...
Path: `.claude/workpackages/excel-to-revit-wps-provider-split/results/<TASK_ID>_result.md`
...
result_file: .claude/workpackages/excel-to-revit-wps-provider-split/results/<TASK_ID>_result.md
...
- **NO_GO** — the task's own gate concluded "do not proceed". This is a valid, useful outcome,
  not a failure.
