...
namespace ArcTool.Core.Commands
{
    ...
    public class QuickDimensionFullMixedReferenceSpikeCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                // Pick two points to define the dimension line
                ...
                // Run the full mixed reference probe
        ...
        private static void AppendTestResult(StringBuilder sb, Models.QuickDimensionFullMixedTestResult result)
        {
            if (result == null)
            {
